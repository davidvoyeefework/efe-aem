! function(e) {
  ...
  e.exports = {
      ...
      _spec: "axios@^0.21.1",
      _where: "/Users/hvittalrao/EFE/Source_Code/landing-utils/node_modules/@fei/neuron",
      author: {
          name: "Matt Zabriskie"
      },
      browser: {
  ...
  ({
      ...
      replacePlaceholderWithData: function(e) {
          Mt ? (this.getDataFieldIdsWithParams("div.form-modal-fe"), Mt && null != document.querySelector("div.form-modal-fe") && (document.querySelector("div.form-modal-fe").innerHTML = this.bodyContent), this.getDataFieldIdsWithParams("div.fe-aem-form")) : this.getDataFieldIds(), this.dataPlacholders.length > 0 && this.dataPlacholders.forEach(function(t, n) {
